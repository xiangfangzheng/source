            ...
            <div class="list-div" id="listDiv">
                <table cellpadding="3" cellspacing="1">
                    ...
                    <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
                            ...
                            <td align="center"><?php if($row["status"] == 1): ?><img src="http://admin.shop.com/Public/Admin/images/yes.gif" /><?php else: ?><img src="http://admin.shop.com/Public/Admin/images/no.gif" /><?php endif; ?></td>
                            <td align="center">
